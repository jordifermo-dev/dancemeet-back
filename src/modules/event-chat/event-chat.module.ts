...
@Module({
  ...
  // needs to call back into EventChatModule, so no forwardRef() here.
  ...
  providers: [
    {
      ...
      useFactory: (
        ...
        return new EventChatService(eventChatRepository, userService, eventService, attendanceService, notificationService);
      },
      inject: [EVENT_CHAT_MODEL, UserService, EventService, AttendanceService, NotificationService],
    },
    EventChatGateway,
  ],
